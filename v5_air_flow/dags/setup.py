...
# Definir PROJECT_HOME dentro del DAG
PROJECT_HOME = "/opt/airflow/practica_creativa"
base_path = "/opt/airflow/practica_creativa/"
...
echo "Base Path: {{ params.base_path }}";
echo "Full File Path: {{ params.base_path }}/{{ params.filename }}";
...
train_classifier_model_operator = BashOperator(
  ...
  bash_command=pyspark_bash_command,
  params={'master': 'local[8]', 'filename': 'resources/train_spark_mllib_model.py', 'base_path': '/opt/airflow/practica_creativa'},
  dag=training_dag
)
